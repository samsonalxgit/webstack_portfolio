    ...
    try {
      ...
      if (isCacheExist) {
        ...
        const courses = await CourseModel.find().select(
          "-coursesData.videoUrl -courseData.suggestion -courseData.questions -courseData.links"
        );
...
export const addReview = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      //check if course id aleardy exists
      ...
      const notification = {
        title: "New otification recieved",
